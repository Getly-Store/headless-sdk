...
them to `POST /api/v1/store/payout-onboarding` — Stripe Connect onboarding is
retired and the endpoint answers 410 `payout_route_retired`.) Everything else is yours.
